...
library MorphoInfo {
    ...
    function getKnownMorphoMarketsParams()
        internal
        pure
        returns (HashMap.Map memory)
    {
        ...
        addMarketParams(
            ...
            MorphoMarketKey({
                chainId: 1,
                borrowAssetSymbol: "DAI",
                collateralAssetSymbol: "USDe"
            }),
            MarketParams({
    ...
    function getMarketParams(
        ...
        string memory borrowAssetSymbol
    ...
    function getKnownMorphoVaultsAddresses()
        internal
        pure
        returns (HashMap.Map memory)
    {
        ...
        addMorphoVaultAddress(
            knownVaults,
            MorphoVaultKey({chainId: 84532, supplyAssetSymbol: "USDC"}),
            0x6bcB6a167C190737858aE6122cc6804207D8eBF3
        );

        return knownVaults;
    }

    function getMorphoVaultAddress(
        uint256 chainId,
        string memory supplyAssetSymbol
    ) internal pure returns (address) {
        HashMap.Map memory knownVaults = getKnownMorphoVaultsAddresses();
        return
            getMorphoVaultAddress(
                knownVaults,
                MorphoVaultKey({
                    chainId: chainId,
                    supplyAssetSymbol: supplyAssetSymbol
                })
            );
    }

    // Helpers for map
    function addMorphoVaultAddress(
        HashMap.Map memory knownVaults,
        MorphoVaultKey memory key,
        address addr
    ) internal pure {
    ...
    function addMarketParams(
        HashMap.Map memory knownMarkets,
        MorphoMarketKey memory key,
    ...
    function getMarketParams(
        ...
        return
            abi.decode(
                HashMap.get(knownMarkets, abi.encode(key)),
                (MarketParams)
            );
    }
